...
X = pd.read_excel(os.path.join("data/prepared_data", "X_train_ready.xlsx"))
y = pd.read_excel(os.path.join("data/prepared_data", "y_train_ready.xlsx"))
...
model.save_model(os.path.join("outputs/models", "catboost_typets_model_v3.cbm"))
